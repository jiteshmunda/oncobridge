      ...
      <div className="container">
        <div className="text-center mb-4">
          <h2 className="fw-bold">
            Comprehensive Oncology Second Opinion Package
          </h2>
          <h5 className="text-muted">
            Gain Unparalleled Clarity: Comprehensive Oncology Second Opinion
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="mb-2">
              ...
              <p className="lead">
                Patients seeking thorough validation, exploring advanced
                treatment options, or desiring direct interaction with a
                world-renowned specialist.
              </p>
            </div>
            <div className="mb-2">
              <p className="lead">
                Our most popular package provides an in-depth review of your
                entire medical history by a leading global oncologist,
                culminating in a personalized report and a direct virtual
                consultation.
              </p>
            </div>
            <div className="mb-2">
            ...
            <p className="lead">
              <strong>Turnaround Time:</strong> 7–10 business days for report,
              consultation in 3–5 days after report.
            </p>
