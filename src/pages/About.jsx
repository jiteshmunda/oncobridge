        ...
        <div className="container py-5">
          ...
          <section className="mb-5">
            ...
            <div className="row">
              ...
              <div className="col-md-12 col-lg-6 col-sm-12  mt-4  mt-lg-0">
                <div className="text-center">
                  <img className='img-fluid rounded-4 shadow-lg unlocking_img' src="https://media.gettyimages.com/id/940272286/vector/bunch-of-keys.jpg?s=1024x1024&w=gi&k=20&c=zRAlCmg3nEJjOUvlvFbq-ZROD7gqJAOCSOdhaq1qQ2o="  alt="Symbolic image of a key unlocking clarity and new treatment options." />
                </div>
              </div>
            </div>
          </section>
